"""Native cognis-connect emit for sbirscout — forward findings to any platform.

Maps sbirscout's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    sbirscout ... --format json | sbirscout-emit --to stix
    sbirscout-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
