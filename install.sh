#!/usr/bin/env sh
# Universal installer for sbirscout. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/sbirscout.git"
echo "Installing sbirscout ..."
